...
//构造函数，一个类只能有一个
 constructor() { 
  this.products = [
    ...
    {id:9,name:"泡椒猪肝盖饭",image:"./assets/img/泡椒猪肝盖饭.jpg",price:14,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:10,name:"炝炒土豆丝盖饭",image:"./assets/img/炝炒土豆丝盖饭.jpg",price:14,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:11,name:"青椒肉丝盖饭",image:"./assets/img/青椒肉丝盖饭.jpg",price:14,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:12,name:"肉沫茄子盖饭",image:"./assets/img/肉沫茄子盖饭.jpg",price:13,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:13,name:"蒜苔肉丝盖饭",image:"./assets/img/蒜苔肉丝盖饭.jpg",price:15,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:14,name:"特色鲜椒鱼+米饭",image:"./assets/img/特色鲜椒鱼+米饭.jpg",price:17,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:15,name:"豆干回锅肉盖饭",image:"./assets/img/豆干回锅肉.jpg",price:15,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    {id:16,name:"土豆红烧肉+米饭",image:"./assets/img/土豆红烧肉+米饭.jpg",price:18,type:"restaurant",special:false,shop:"几样菜.盖浇饭"},
    ...
    {id:23,name:"海鲜铁板炒饭",image:"./assets/img/海鲜铁板.jpg",price:17,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:24,name:"香辣口味虾仁铁板炒饭",image:"./assets/img/虾仁铁板.jpg",price:14.5,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:25,name:"肉宴海鲜铁板炒饭",image:"./assets/img/肉宴海鲜.jpg",price:17,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:26,name:"蒜蓉粉丝扇贝铁板炒饭",image:"./assets/img/蒜蓉粉丝.jpg",price:18,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:27,name:"炭烧鱿鱼须铁板炒饭",image:"./assets/img/鱿鱼须.jpg",price:15,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:28,name:"海虾鱿鱼铁板炒饭",image:"./assets/img/海虾鱿鱼.jpg",price:22,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:29,name:"滑蛋虾仁菠萝炒饭",image:"./assets/img/滑蛋菠萝.jpg",price:15,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
    {id:30,name:"海鲜菠萝炒饭",image:"./assets/img/海鲜菠萝.jpg",price:17,type:"restaurant",special:false,shop:"鱿小贝.海鲜炒饭"},
